package edu.aku.hassannaqvi.smkHhMl2022.core;

import static edu.aku.hassannaqvi.smkHhMl2022.database.DatabaseHelper.DATABASE_NAME;
import static edu.aku.hassannaqvi.smkHhMl2022.database.DatabaseHelper.DATABASE_PASSWORD;
...
public class MainApp extends Application {
    ...
    public static final String _HOST_URL = MainApp._IP + "/smkHhMl2022/api/";// .TEST server;
    ...
    public static final String _UPDATE_URL = MainApp._IP + "/smkHhMl2022/app/survey";
    ...
    public static int versionCode = edu.aku.hassannaqvi.smkHhMl2022.BuildConfig.VERSION_CODE;
