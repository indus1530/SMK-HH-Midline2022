...
import edu.aku.hassannaqvi.smkHhMl2022.databinding.ActivitySectionH22Binding;

public class SectionH22Activity extends AppCompatActivity {


    private static final String TAG = "SectionH22Activity";
    ActivitySectionH22Binding bi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bi = DataBindingUtil.setContentView(this, R.layout.activity_section_h22);
