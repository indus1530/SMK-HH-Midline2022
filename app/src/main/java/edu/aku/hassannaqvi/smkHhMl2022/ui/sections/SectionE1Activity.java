...
import edu.aku.hassannaqvi.smkHhMl2022.databinding.ActivitySectionE1Binding;
...
public class SectionE1Activity extends AppCompatActivity {
    ...
    public void btnContinue(View view) {
        ...
        if (updateDB()) {
            setResult(RESULT_OK);
            Intent i;
            i = new Intent(this, SectionE2Activity.class).putExtra("complete", true).setFlags(Intent.FLAG_ACTIVITY_FORWARD_RESULT);
            startActivity(i);
            finish();
        } else {
