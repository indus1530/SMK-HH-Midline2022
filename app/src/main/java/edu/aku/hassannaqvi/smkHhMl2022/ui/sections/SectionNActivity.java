...
import edu.aku.hassannaqvi.smkHhMl2022.databinding.ActivitySectionNBinding;
...
public class SectionNActivity extends AppCompatActivity {
    ...
    public void btnContinue(View view) {
        ...
        if (updateDB()) {
            setResult(RESULT_OK);
            Intent i;
            i = new Intent(this, SectionUNActivity.class).putExtra("complete", true).setFlags(Intent.FLAG_ACTIVITY_FORWARD_RESULT);
            startActivity(i);
            finish();
        } else {
