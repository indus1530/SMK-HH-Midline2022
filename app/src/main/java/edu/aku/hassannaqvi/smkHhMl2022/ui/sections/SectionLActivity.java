...
import edu.aku.hassannaqvi.smkHhMl2022.databinding.ActivitySectionLBinding;
...
public class SectionLActivity extends AppCompatActivity {
    ...
    public void btnContinue(View view) {
        ...
        if (updateDB()) {
            setResult(RESULT_OK);
            Intent i;
            i = new Intent(this, SectionMActivity.class).putExtra("complete", true).setFlags(Intent.FLAG_ACTIVITY_FORWARD_RESULT);
            startActivity(i);
            finish();
        } else {
