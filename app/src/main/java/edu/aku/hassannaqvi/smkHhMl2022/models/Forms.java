...
public class Forms extends BaseObservable implements Observable {
    ...
    @Bindable
    public String getAh3a() {
        return ah3a;
    }

    public void setAh3a(String ah3a) {
        this.ah3a = ah3a;
        notifyPropertyChanged(BR.ah3a);
    }
    ...
    @Bindable
    public String getAh7x() {
        return ah7x;
    }

    public void setAh7x(String ah7x) {
        this.ah7x = ah7x;
        notifyPropertyChanged(BR.ah7x);
    }
