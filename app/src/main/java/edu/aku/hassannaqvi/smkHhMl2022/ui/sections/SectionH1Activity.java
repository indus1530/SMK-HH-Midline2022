...
import edu.aku.hassannaqvi.smkHhMl2022.databinding.ActivitySectionH1Binding;
...
public class SectionH1Activity extends AppCompatActivity {
    ...
    public void btnContinue(View view) {
        ...
        if (updateDB()) {
            setResult(RESULT_OK);
            Intent i;
            i = new Intent(this, SectionH2Activity.class).putExtra("complete", true).setFlags(Intent.FLAG_ACTIVITY_FORWARD_RESULT);
            startActivity(i);
            finish();
        } else {
