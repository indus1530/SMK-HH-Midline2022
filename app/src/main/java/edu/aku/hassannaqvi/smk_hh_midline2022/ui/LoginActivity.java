...
import static edu.aku.hassannaqvi.smk_hh_midline2022.core.CipherSecure.decryptGCM;
import static edu.aku.hassannaqvi.smk_hh_midline2022.core.CipherSecure.encryptGCM;
import static edu.aku.hassannaqvi.smk_hh_midline2022.core.CipherSecure.hashSHA256;
...
import static edu.aku.hassannaqvi.smk_hh_midline2022.database.DatabaseHelper.DATABASE_COPY;
import static edu.aku.hassannaqvi.smk_hh_midline2022.database.DatabaseHelper.DATABASE_NAME;
...
import edu.aku.hassannaqvi.smk_hh_midline2022.MainActivity;
import edu.aku.hassannaqvi.smk_hh_midline2022.R;
import edu.aku.hassannaqvi.smk_hh_midline2022.contracts.TableContracts;
import edu.aku.hassannaqvi.smk_hh_midline2022.core.AppInfo;
...
import edu.aku.hassannaqvi.smk_hh_midline2022.databinding.ActivityLoginBinding;
   ...
   /* private int PhotoSerial = 0;
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.hassannaqvi.smk_hh_midline2022.ui.SyncActivity.class).putExtra("login", true));
        } else {
