package edu.aku.hassannaqvi.smk_hh_midline2022.core;

import static edu.aku.hassannaqvi.smk_hh_midline2022.database.DatabaseHelper.DATABASE_NAME;
import static edu.aku.hassannaqvi.smk_hh_midline2022.database.DatabaseHelper.DATABASE_PASSWORD;
...
public class MainApp extends Application {
    ...
    public static final String PROJECT_NAME = "smk_hh_midline2022";
    ...
    public static final String _HOST_URL = MainApp._IP + "/smk_hh_midline2022/api/";// .TEST server;
    ...
    public static final String _UPDATE_URL = MainApp._IP + "/smk_hh_midline2022/app/survey";
    ...
    public static int versionCode = edu.aku.hassannaqvi.smk_hh_midline2022.BuildConfig.VERSION_CODE;
    public static String versionName = edu.aku.hassannaqvi.smk_hh_midline2022.BuildConfig.VERSION_NAME;
